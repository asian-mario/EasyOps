...
classes = [
    ...
    operators.OBJECT_OT_easy_mirror,
    operators.OBJECT_OT_easy_mirror_gizmo,
    operators.OBJECT_OT_easy_edge_wear,
    operators.OBJECT_OT_easy_edge_wear_regenerate,
    operators.OBJECT_OT_easy_edge_wear_remove,
